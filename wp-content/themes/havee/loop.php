...
<div id="postz-<?php the_ID(); ?>"  class="postz" >
			...
			<span style="font-size: 17px; color: #05AAC6;"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'target' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php if ( get_the_title() == '' ) { _e( '(No title)', 'target' ); } else { the_title(); } ?></a></span>
